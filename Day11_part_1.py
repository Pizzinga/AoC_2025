...
with open("Day11_input1.txt") as f:
    ...
    while len(stack)>0:
        ...
        if nodo_actual==DEST:
            Value_nodes[DEST]+=1
            Value_nodes[nodi_visitati_questa_ricerca]-=1
            nodi_visitati_questa_ricerca=[];
            continue;
        elif Value_nodes[nodo_actual]==1:
